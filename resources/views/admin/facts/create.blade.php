...
@section('title',settings()->website_title .' | '. __('words.create_fact'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <apan class="text-muted">{{__('words.create_fact')}}</apan>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
@section('form_action',route('facts.store'))
    ...
    <div class="card card-custom mb-2">
        <div class="card-header card-header-tabs-line">
            <div class="card-title">
                <h3 class="card-label">{{__('words.create_fact')}}</h3>
            </div>
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}"
                        ...
                        <div class="col form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="{{ $locale . '[fact_number]' }}"
                                       placeholder="{{__('words.fact_number')}}"
                                       class="form-control  pl-5 min-h-40px @error($locale . '.fact_number') is-invalid @enderror"
                                       value="{{ old($locale . '.fact_number') }}">
