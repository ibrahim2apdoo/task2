...
@section('title',settings()->website_title .' | '.__('words.show_fact'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <apan class="text-muted">{{__('words.show_fact')}}</apan>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    ...
    <div class="card card-custom card-stretch gutter-b">
        <div class="card-header card-header-tabs-line">
            <div class="card-title">
                <h3 class="card-label">{{__('words.show_fact')}}</h3>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-7 bg-light p-5 rounded h-100">
                                    ...
                                    <p class="m-0">{{ $fact->translate($locale)->title }}</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-7 bg-light p-5 rounded h-100">
                                    <div class="card-title">
                                        <h5 class="font-weight-bolder text-dark">{{__('words.fact_number')}}
                                            - {{__('words.locale-' . $locale)}}:</h5>
                                    </div>
                                    <p class="m-0">{{ $fact->translate($locale)->fact_number }}</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0">{{ createdAtFormat($fact->created_at) }}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0">{{ createdAtFormat($fact->created_at) == updatedAtFormat($fact->updated_at) ? '--' : updatedAtFormat($fact->updated_at) }}</p>
                        </div>
                    </div>
