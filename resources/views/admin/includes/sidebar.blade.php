<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
 ...
 {{-- facts routes start --}}
                ...
                {{-- userContact routes start --}}
                @permission('read-clients')
                <li class="menu-item menu-item-submenu {{ request()->routeIs('clients.*') ? 'menu-item-open menu-item-here' : '' }}"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <i class="fas fa-handshake svg-icon menu-icon"></i>
                        <span class="menu-text">{{__('words.userContact')}}</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            @permission('read-clients')
                            <li class="menu-item  {{ request()->routeIs('userContact.index') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{route('userContact.index')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{__('words.show_all')}}</span>
