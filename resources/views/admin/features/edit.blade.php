                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}"
                        ...
                        <div class="col form-group">
                            ...
                            <textarea
                                ...
                                rows="4">{{ old($locale . '.short_description',$feature->translate($locale)->short_description) }} </textarea>
    ...
    <div class="card card-custom">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                @include('admin.components.switch',['label'=>__('words.status'),'name'=>'status','val' => old('status',$feature->status)])
            </div>
