...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="s2-about_img">
                            <img src="{{asset('website/assets/img/saas-c/about/s_ab1.png')}}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="s2-about_text_icon">
                            ...
                            <div class="s2-about_text saas2-headline pera-content">
                                ...
                                <a href="!#">More about the software </a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-12 wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="s2-about_text_icon">
                            ...
                            <div class="s2-about_text saas2-headline pera-content">
                                ...
                                <a href="!#">Read all customer stories </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="s2-about_img">
                            <img src="{{asset('website/assets/img/saas-c/about/s_ab2.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="str-about" class="str-about-section position-relative">
        <div class="str-aboutbg1 position-absolute"><img src="{{asset('website/assets/img/startup/shape/vs1.png')}}" alt=""></div>
        <div class="str-aboutbg2 position-absolute"><img src="{{asset('website/assets/img/startup/shape/vs2.png')}}" alt=""></div>
        <div class="str-aboutbg3 position-absolute"><img src="{{asset('website/assets/img/startup/shape/vs3.png')}}" alt=""></div>
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="str-about-img position-relative wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="str-about-shape"><img src="{{asset('website/assets/img/startup/shape/abs.png')}}" alt=""></div>
                            <div class="str-about-logo"><img src="{{asset('website/assets/img/startup/about/ab-logo.png')}}" alt=""></div>
                            <div class="str-about-img-field">
                                <div class="str-about-pic">
                                    <img src="{{asset('website/assets/img/startup/about/ab1.png')}}" alt="">
                                </div>
                            ...
                            <div class="str-about-img-field">
                                <div class="str-about-pic">
                                    <img src="{{asset('website/assets/img/startup/about/ab2.png')}}" alt="">
                                </div>
                                <div class="str-about-pic">
                                    <img src="{{asset('website/assets/img/startup/about/ab3.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Start of pricing section
        ============================================= -->
    <section style="margin-bottom: 100px" id="s2-pricing" class="s2-pricing_section">
        <div class="container">
