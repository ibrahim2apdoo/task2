...
@section('content')
    <!-- Start of Service page section
        ============================================= -->
    <section style="margin-top: 100px;" id="saas_two_service" class="saas_two_service_section">
        <div class="container">
    ...
    <section id="ei-appdownload" class="ei-appdownload-section position-relative" data-background="assets/img/app-landing/background/appbg1.png">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="ei-app-mockup-img  wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <img src="{{asset('website/')}}/assets/img/app-landing/mockup/amu1.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="ei-app-down-text wow fadeFromLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                            ...
                            <div class="app-down-btn">
                                <a href="#"><img src="{{asset('website/')}}/assets/img/app-landing/shape/btn1.png" alt=""></a>
                                <a href="#"><img src="{{asset('website/')}}/assets/img/app-landing/shape/btn2.png" alt=""></a>
                            </div>
        ...
        <div class="ei-appdownloaad-shape app-shape1" data-parallax='{"y" : -100}'><img src="{{asset('website/')}}/assets/img/app-landing/background/apps1.png" alt=""></div>
        <div class="ei-appdownloaad-shape app-shape2" data-parallax='{"x" : -120}'><img src="{{asset('website/')}}/assets/img/app-landing/background/apps2.png" alt=""></div>
        <div class="ei-appdownloaad-shape app-shape3" data-parallax='{"y" : -100}'><img src="{{asset('website/')}}/assets/img/app-landing/background/apps3.png" alt=""></div>
    </section>
    ...
    <!-- Start of testimonial section
       ============================================= -->
    <section style="margin-bottom: 100px;" id="testimonial" class="testimonial_section">
        <div class="container">
                            ...
                            <div class="testimonial_indicator relative-position">
                                <ol class="carousel-indicators">
                                    <li data-target="#testimonial_slide" data-slide-to="0" class="active">
                                        <img src="{{asset('website/')}}/assets/img/saas-m/testimonial/tst1.png" alt="">
                                    </li>
                                    <li data-target="#testimonial_slide" data-slide-to="1">
                                        <img src="{{asset('website/')}}/assets/img/saas-m/testimonial/tst2.png" alt="">
                                    </li>
                                    <li data-target="#testimonial_slide" data-slide-to="2">
                                        <img src="{{asset('website/')}}/assets/img/saas-m/testimonial/tst3.png" alt="">
                                    </li>
                                    <li data-target="#testimonial_slide" data-slide-to="3">
                                        <img src="{{asset('website/')}}/assets/img/saas-m/testimonial/tst4.png" alt="">
                                    </li>
                                    <li data-target="#testimonial_slide" data-slide-to="4">
                                        <img src="{{asset('website/')}}/assets/img/saas-m/testimonial/tst5.png" alt="">
                                    </li>
                                    <li data-target="#testimonial_slide" data-slide-to="5">
                                        <img src="{{asset('website/')}}/assets/img/saas-m/testimonial/tst6.png" alt="">
                                    </li>
                                </ol>
                            </div>
                        </div>
