...
class ClientController extends Controller
{
    ...
    public function update(ClientRequest $request, Client $client)
    {
        try {
            ...
            return redirect()->route('Client.index')->with(['success' => __('message.updated_successfully')]);
        } catch (\Exception $e) {
            return redirect()->back()->with(['error' => __('message.something_wrong')]);
        }
    }
    ...
    public function destroy(Client $client)
    {
        try {
            $client->deleteFile();
            $client->delete();
            return redirect()->route('Client.index')->with(['success' => __('message.deleted_successfully')]);
        } catch (\Exception $e) {
